...
type ToolsConfig struct {
	...
	ETMS   ETMSToolsConfig   `json:"etms"`
}

// ETMSToolsConfig configures the ETMS (Elderly Tracking & Monitoring System) tools.
type ETMSToolsConfig struct {
	Enabled     bool   `json:"enabled"      env:"PICOCLAW_TOOLS_ETMS_ENABLED"`
	OpenClawURL string `json:"openclaw_url" env:"PICOCLAW_TOOLS_ETMS_OPENCLAW_URL"`
}
